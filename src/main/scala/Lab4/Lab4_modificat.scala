...
object Ex4_modificat {
    def main(args: Array[String]) {
        ...
        val player2Card2 = Chain(^^(player1Card1, player2Card1, player1Card2), (playercards: (Int, Int, Int)) =>
            // Player 2 can get any card except the first player’s card
            discrete.Uniform(cards.filter(_ != playercards._1 && _ != playercards._2 && _ != playercards._3):_*)
        )
       ...
       // This element represents the gain to player 1 from the game. I have
        ...
        val player1Gain = Apply(player1Card1,player1Card2, player2Card1, player2Card2, player1Bet1, player2Bet, player1Bet2,
            (card1: Int, card2: Int, card3: Int, card4: Int, bet11: Boolean, bet2: Boolean, bet12: Boolean) =>
                if (!bet11 && !bet2) 0.0
                else if (bet11 && !bet2) 1.0
                else if (!bet11 && bet2 && !bet12) -1.0
                else if ((card1 > card3) || (card1 > card4)|| (card2 > card3) || (card2 > card4 )) 2.0
                else -2.0
        )
